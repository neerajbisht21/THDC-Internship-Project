...
import {
  Box, Table, Thead, Heading, Tbody, Tr, Th, Td, TableContainer, Text, Tag, Button
...
const AdminNewComplaints = () => {
  ...
  const formatDate = (dateString) => {
    return moment(dateString).format('MMMM D, YYYY h:mm A'); // Format example: July 22, 2024 7:19 AM
  };
  ...
  return (
    <>
      <Box
        ...
        overflowX="auto"
        bg="gray.50"
        maxH="90vh"            // Added max height
        overflowY="auto"       // Added vertical scroll if needed
      >
        ...
        <Box overflowX="auto">
          ...
          >
            <Table variant="simple" size="sm">
              ...
              <Tbody>
                {allEmployeeComplaints && allEmployeeComplaints
